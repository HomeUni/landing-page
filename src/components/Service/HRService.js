        ...
        return(
            <section className="prototype_service_info">
                ...
                <div className="container">
                    <h2 className="f_size_30 f_600 t_color3 l_height45 text-center mb_90">HomeUni is built for designers like you.<br/> With useful features, an intuitive interface.</h2>
