          ...
          <nav className={`navbar navbar-expand-lg menu_one ${mClass}`}>
            <div className={`container ${cClass}`}>
              <Link className={`navbar-brand ${slogo}`} to="/">
                <img width={150} src={require("../img/logo2.png")} alt="" />
                <img width={150} src={require("../img/logo2.png")} alt="logo" />
              </Link>
              <button
              ...
              >
                ...
                <a
                  style={{ marginTop: 10, marginBottom: 10, backgroundColor: '#fba249', borderColor: '#fba249', color: 'white' }}
